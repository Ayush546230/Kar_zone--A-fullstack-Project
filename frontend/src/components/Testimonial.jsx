...
import testinomials from "../assets/Testimonialdata";
      ...
      <div className={styles.innerContainer}>
        <div className={styles.headerContainer}>
          ...
          <p className={styles.subtitle}>
            Hear from our valued customer about their journey with our premium
            fleet
          </p>
        </div>
        <div className={styles.grid}>
          {testinomials.map((t, index) => {
        ...
        <div className={styles.ctaContainer}>
            ...
            <a href="/cars" className={styles.ctaButton}>Book Your Luxuary Ride</a>
          </div>
      </div>
