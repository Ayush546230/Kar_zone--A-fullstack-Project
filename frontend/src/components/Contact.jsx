...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    window.open(
      `https://wa.me/+919304049070?text=${whatsappMessage}`,
      "_blank"
    );
        ...
        <div className={styles.cardContainer}>
              ...
              <div className={styles.infoItemContainer}>
                {[
                  ...
                  },
                  {
                    icon: FaEnvelope,
                    label: "Email",
                    value: "ayushsrivastava18623@gmail.com",
          ...
          <div className={styles.formCard}>
            ...
            <form action="" onSubmit={handleSubmit} className={styles.form}>
              ...
              <button type="submit" className={styles.submitButton}>Send Message <FaWhatsapp className={styles.whatsappIcon}/></button>
            </form>
          </div>
        </div>
      </div>
